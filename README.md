...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-wf6yaus.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-wf6yaus.containers.anotherwebservice.com/
...
```
git clone git@github.com:Kab1r/container-wf6yaus.git
cd container-wf6yaus
```
...
```
docker attach container-wf6yaus
```
